...
ifndef
     HEXA_VERSION := Hexa-v$(HEXA_BASE_VERSION)-$(HEXA_OTA_BRANCH)-$(BUILD_DATE)-$(BUILD_TYPE)-$(BUILD_TIME)
 ifeq ($(USE_GAPPS),true)
     HEXA_VERSION := Hexa-v$(HEXA_BASE_VERSION)-$(HEXA_OTA_BRANCH)-Gapps-$(BUILD_DATE)-$(BUILD_TYPE)-$(BUILD_TIME)
 endif
endif
